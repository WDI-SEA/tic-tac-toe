...
var displayCurrentPlay = function() {
  document.getElementById('current-play').innerHTML = currentPlay + 1;
}
displayCurrentPlay();
...
for (var i = 0; i <= 8; i++) {
  ...
  //console.log(document.getElementsByClassName("square")[i]);
...
resetButton.addEventListener('click', function() {
  for (var i = 0; i <= 8; i++) {
    element[i].innerHTML = '';
    element[i].classList.remove('red');
    element[i].classList.remove('blue');
    displayCurrentPlay();
    currentPlay = 0;
  }
});
